...
async def cancel_conversation(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Fallback handler for cancel_op inside any conversation."""
    query = update.callback_query
    if query:
        await query.answer()
        await cancel_user_operations(query.from_user.id)
...
# ════════════════════════════════════════════════════════════
#  ConversationHandler definitions   ← FIXED: removed per_message=True
# ════════════════════════════════════════════════════════════
...
add_account_conv = ConversationHandler(
    ...
    per_chat=False,
    per_user=True,
    # per_message intentionally left as default False
)
